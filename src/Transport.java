...
public abstract class Transport <T extends Driver> implements Competing {
    ...
    public boolean equals(Object o) {
        ...
        return Double.compare(transport.getEngineVolume(), getEngineVolume()) == 0 && Objects.equals(getBrand(), transport.getBrand()) && Objects.equals(getModel(), transport.getModel()) && Objects.equals(getDriver(), transport.getDriver()) && Objects.equals(getMechanicsList(), transport.getMechanicsList());
    }

    @Override
    public int hashCode() {
        return Objects.hash(getBrand(), getModel(), getEngineVolume(), getDriver(), getMechanicsList());
    }
